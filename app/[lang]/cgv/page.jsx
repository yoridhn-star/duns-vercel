...
export default async function CgvPage({ params }) {
  ...
  const c = isFr
    ? {
        ...
        s3t: "Conformément à l'article L221-28 du Code de la consommation, le droit de rétractation ne s'applique pas aux contenus numériques fournis immédiatement après l'achat. Le service étant exécuté instantanément à la confirmation du paiement, aucun remboursement ne peut être accordé.",
        s4: "Responsabilité",
        s4t: "DUNS Verify met en œuvre tous les moyens raisonnables pour fournir un résultat exact. Cependant, les informations proviennent de bases de données tierces et DUNS Verify ne peut garantir leur exhaustivité ou exactitude. En cas d'absence de résultat, aucun remboursement n'est accordé mais vous pouvez contacter notre support à contact@dunsverify.com.",
    ...
    : {
        ...
        s3: "Refund Policy",
        s3t: "As this is a digital service delivered instantly upon payment confirmation, no refunds can be issued once the service has been executed. The service is consumed immediately at the time of purchase.",
        s4: "Liability",
        s4t: "DUNS Verify uses all reasonable means to provide accurate results. However, information comes from third-party databases and DUNS Verify cannot guarantee their completeness or accuracy. In case of no result, no refund is granted, but you may contact our support at contact@dunsverify.com.",
        s5: "Personal Data",
